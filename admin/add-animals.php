                                        ...
                                        <div class="card-body">
                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="scname" name="scname" aria-describedby="emailHelp" placeholder="Enter Scientific Name" value="" required="true">
                                                </div>
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="feeding" name="feeding" aria-describedby="emailHelp" placeholder="Enter Feeding of animal" value="" required="true">
                                                </div>
                                                <div class="form-group">
                                                    <label for="repro">Reproduction</label>
                                                    <input type="text" class="form-control" id="repro" name="repro" aria-describedby="emailHelp" placeholder="Enter Reproduction of animal" value="" required="true">
                                                </div>
                                                <div class="form-group">
                                                    <label for="socialLife">Social Life</label>
                                                    <input type="text" class="form-control" id="socialLife" name="socialLife" aria-describedby="emailHelp" placeholder="Enter Social Life of animal" value="" required="true">
                                                </div>
                                                <div class="form-group">
                                                    <label for="sConversation">State of Conservation</label>
                                                    <input type="text" class="form-control" id="sConversation" name="sConversation" aria-describedby="emailHelp" placeholder="Enter Station of Conservation of animal" value="" required="true">
                                                </div>
