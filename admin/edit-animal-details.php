                                            ...
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                ?>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="scname" name="scname" aria-describedby="emailHelp" placeholder="Enter animal Name" value="<?php echo $row['ScientificName']; ?>" required="true">
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="feeding" name="feeding" aria-describedby="emailHelp" placeholder="Enter Description of animal" value="<?php echo $row['Feeding']; ?>" required="true">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="repro">Reproduction</label>
                                                        <input type="text" class="form-control" id="repro" name="repro" aria-describedby="emailHelp" placeholder="Enter Description of animal" value="<?php echo $row['Reproduction']; ?>" required="true">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="socialLife">Social Life</label>
                                                        <input type="text" class="form-control" id="socialLife" name="socialLife" aria-describedby="emailHelp" placeholder="Enter Description of animal" value="<?php echo $row['SocialLife']; ?>" required="true">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="sConversation">State of Conservation</label>
                                                        <input type="text" class="form-control" id="sConversation" name="sConversation" aria-describedby="emailHelp" placeholder="Enter Description of animal" value="<?php echo $row['StateOfConservation']; ?>" required="true">
                                                    </div>
                                                <?php } ?>
